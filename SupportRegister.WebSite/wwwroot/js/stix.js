$.fn.stix = function(){
	...
	var editbtn=$("<button class=\"stix operationbtn editbtn\">Sửa</button>");
	var savebtn=$("<button class=\"stix operationbtn hidden savebtn\">Lưu</button>");
	var cancelbtn=$("<button class=\"stix operationbtn hidden cancelbtn\">Hủy</button>");
